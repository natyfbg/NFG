...
workouts = [
    {"name": "Push-Up", "level": "Beginner", "body_part": "Chest", "style": "BodyWeight",
     "is_favorite": True, "rating": 4.6, "tags": ["push","chest","bodyweight"]},
    {"name": "Goblet Squat", "level": "Beginner", "body_part": "Legs", "style": "Dumbbell",
     "is_favorite": False, "rating": 4.2, "tags": ["squat","legs","dumbbell"]},
    {"name": "Barbell Row", "level": "Intermediate", "body_part": "Back", "style": "Barbell",
     "is_favorite": False, "rating": 4.5, "tags": ["row","back","barbell","lats"]},
    {"name": "Deadlift", "level": "Advanced", "body_part": "Back", "style": "Barbell",
     "is_favorite": True, "rating": 4.9, "tags": ["hinge","back","hamstrings","barbell"]},
]
